...
?>
<div id="main">
    <h3 class="zidaohang">当前位置：<a href="./index.php">首页</a> &gt; <?php echo $row['cate_name'];?></h3>
    <ul>
        <?php
        $pageSize=5;
        $url="index.php";
        ...
        while($row=mysqli_fetch_assoc($res)){
            echo '<li>';
//            echo '<img src="./upfiles/'.$row['img'].'" alt=""/>';
            ...
            <tr>
                <td align="right" nowrap="true" style="background-color: rgb(255, 255, 255);">
                    <div style="color:blue;" id="turn-page">
                        ...
                        页&emsp;
                        <span id="page-link">
                            <a style="color:blue;" href="list.php?cate_id=<?php echo $cate_id?>&page=1">第一页</a>&emsp;
                            <a style="color:blue;" href="list.php?cate_id=<?php echo $cate_id?>&page=<?php echo $pre_page;?>">上一页</a>&emsp;
                            <a style="color:blue;" href="list.php?cate_id=<?php echo $cate_id?>&page=<?php echo $next_page;?>">下一页</a>&emsp;
                            <a style="color:blue;" href="list.php?cate_id=<?php echo $cate_id?>&page=<?php echo $total_page;?>">最末页</a>
                        </span>
                    </div>
                </td>
            </tr>
